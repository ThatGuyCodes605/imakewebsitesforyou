# how to do the typewriter effect
```
document.addEventListener("DOMContentLoaded", () => {
  // 🟢 Typewriter
  const words = [
    { text: "CSS", color: "#2465F1" }, //adds word CSS make it color #2465F1
  ...
  const typeEl = document.getElementById("typewriter"); //gets id from html file
  let i = 0, j = 0, deleting = false;
  const speed = 100, delay = 1200, eraseSpeed = 60; //sets speed
